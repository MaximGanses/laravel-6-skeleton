...
class Roles
{
    ...
    private function getAvailableUsers(Role $role): array
    {
        /** @var User[] $nonmembers */
    ...
    private function getDeleteAblePermissions(Role $role): array
    {
    ...
    private function getPermissionList(Role $role): array
    {
        $arr = [];
        $permissions = $role->permissions()->getResults();
